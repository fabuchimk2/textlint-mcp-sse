...
export const options = optionator({
    ...
    options: [
        ...
        },
        {
            ...
            type: "Boolean",
            default: false,
            description: "Start textlint as the Model Context Protocol (MCP) server with stdio transport.",
            example: "--mcp"
        },
        {
            option: "mcp-http",
            ...
            example: "--mcp-http --mcp-port 3000"
        },
        {
            option: "mcp-port",
            type: "Number",
            ...
            example: "--mcp-http --mcp-port 8080"
        },
        {
            option: "mcp-host",
            type: "String",
            ...
            example: "--mcp-http --mcp-host localhost"
        },
        {
            option: "mcp-cors",
            type: "Boolean",
